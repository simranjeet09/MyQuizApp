...
export default function MediumGameMode({ navigation }) {
        ...
        async function myfun() {
            try {
                const response = await fetch(
                  'https://quizapi.io/api/v1/questions?apiKey=6M4lbRBLzZbcub4zUHOPsHjXl1kV3K2N3V82fvZF&category=code&difficulty=medium&limit=10'
                );
